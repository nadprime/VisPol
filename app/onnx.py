...
class V5:
    def __init__(self, conf_thres=0.5, iou_thres=0.5, img_size=640):
        ...
        self.name= ['GRAFFITI','FADED_SIGNAGE','POTHOLES','GARBAGE','CONSTRUCTION_ROAD',
        'BROKEN_SIGNAGE','BAD_STREETLIGHT','BAD_BILLBOARD','SAND_ON_ROAD',
        'CLUTTER_SIDEWALK','UNKEPT_FACADE']
        ...
        self.session = ort.InferenceSession('../models/theme1.onnx', providers=self.providers)# self.cuda= cuda
